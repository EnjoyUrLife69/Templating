...
<body>
                                                    ...
                                                    <div class="homemenu-items">
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb">
                                                                <img src="{{asset ('frontend/assets/img/header/home-1.jpg')}}" alt="img">
                                                        ...
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb mb-15">
                                                                <img src="{{asset ('frontend/assets/img/header/home-2.jpg')}}" alt="img">
                                                                <div class="demo-button">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-9">
                    <div class="herov2-content position-relative">
                        ...
                        <!-- Element -->
                        <img src="{{asset ('frontend/assets/img/abanner/reg.png')}}" alt="img" class="small-aregtengle">
                    </div>
                </div>
            </div>
        </div>
        <!-- Element -->
        <img src="{{asset ('frontend/assets/img/abanner/kyte.png')}}" alt="img" class="banner-kyte">
        <img src="{{asset ('frontend/assets/img/abanner/banner-v2-thumb.png')}}" alt="img" class="banner-shape wow fadeInLeft"
            data-wow-delay=".3s">
        <img src="{{asset ('frontend/assets/img/abanner/banner-shadow.png')}}" alt="img" class="banner-shadow">
    </section>
                    ...
                    <div class="about-thumb-innerv2">
                        <div class="thumb-left-cont">
                            <div class="thumb-cont wow fadeInLeft" data-wow-delay="0.3s">
                                <img src="{{asset ('frontend/assets/img/about/about-icon.png')}}" alt="img" class="aicon">
                                <div class="contents">
                                    <h4>
                            ...
                            <div class="thumb wow fadeInUp" data-wow-delay=".4s">
                                <img src="{{asset ('frontend/assets/img/about/aboutv2-1.png')}}" alt="img">
                            </div>
                        </div>
                        <div class="right-thumb d-sm-block d-none wow fadeInDown" data-wow-delay=".5s">
                            <img src="{{asset ('frontend/assets/img/about/aboutv2-2.png')}}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-xxl-4 g-3">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="student-count-item">
                        <div class="icon">
                            <img src="{{asset ('frontend/assets/img/aicon/team-count1.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <h1>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="student-count-item">
                        <div class="icon">
                            <img src="{{asset ('frontend/assets/img/aicon/team-count2.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <h1>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="student-count-item">
                        <div class="icon">
                            <img src="{{asset ('frontend/assets/img/aicon/team-count3.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <h1>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="student-count-item">
                        <div class="icon">
                            <img src="{{asset ('frontend/assets/img/aicon/team-count4.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <h1>
    ...
    <section class="extra-sectionv position-relative fix section-padding">
        <div class="container">
            ...
            <div class="row g-lg-4 g-4">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items extra-class-item">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/class1.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class1.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class1.png')}}');">
                                </div>
                        ...
                        <div class="news-content">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-xxl-2">
                                ...
                                <img src="{{asset ('frontend/assets/img/ablog/class-icon1.png')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items extra-class-item">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/class2.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class2.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class2.png')}}');">
                                </div>
                        ...
                        <div class="news-content">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-xxl-2">
                                <a href="service-details.html" class="theme-btn-2 fw-medium black">learn more <i
                                        class="fas fa-long-arrow-right p3-clr"></i></a>
                                <img src="{{asset ('frontend/assets/img/ablog/class-icon2.png')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="news-card-items extra-class-item">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/class3.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class3.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/class3.png')}}');">
                                </div>
                        ...
                        <div class="news-content">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-xxl-2">
                                <a href="service-details.html" class="theme-btn-2 fw-medium black">learn more <i
                                        class="fas fa-long-arrow-right p3-clr"></i></a>
                                <img src="{{asset ('frontend/assets/img/ablog/class-icon3.png')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Element -->
        <img src="{{asset ('frontend/assets/img/ablog/class-j.png')}}" alt="img" class="jerap-element d-lg-block d-none">
    </section>
    ...
    <section class="clone-component-section space-top cmn-bg overflow-hidden position-relative">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="brand-image">
                            <img src="{{asset ('frontend/assets/img/aclient/sponsor1.png')}}" alt="brand-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-image">
                            <img src="{{asset ('frontend/assets/img/aclient/sponsor2.png')}}" alt="brand-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-image">
                            <img src="{{asset ('frontend/assets/img/aclient/sponsor3.png')}}" alt="brand-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-image">
                            <img src="{{asset ('frontend/assets/img/aclient/sponsor4.png')}}" alt="brand-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-image">
                            <img src="{{asset ('frontend/assets/img/aclient/sponsor5.png')}}" alt="brand-img">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row flex-row-reverse align-items-center justify-content-between g-4">
                        <div class="col-lg-6 col-md-6">
                            <div class="products-thumb w-100 wow fadeInDown" data-wow-delay="0.6s">
                                <img src="{{asset ('frontend/assets/img/aclient/clode-car.png')}}" alt="img" class="w-100">
                            </div>
                        </div>
        ...
        <div class="sun-uncle-section space-top position-relative overflow-hidden">
            <img src="{{asset ('frontend/assets/img/aclient/clone-object.png')}}" alt="img" class="w-100 sun-bg">
            <div class="sun-unlce text-center">
                <img src="{{asset ('frontend/assets/img/aclient/clone-sun.png')}}" alt="img">
            </div>
        </div>
        <!-- Element-->
        <img src="{{asset ('frontend/assets/img/aclient/bard.png')}}" alt="img" class="bard-element d-md-block d-none">
    </section>
            ...
            <div class="row flex-row-reverse align-items-md-center g-4">
                ...
                <div class="col-lg-6 col-md-6 col-sm-5">
                    <div class="carft-thumb p-sm-0 p-3 w-100 pe-lg-4 wow fadeInDown" data-wow-delay=".5s">
                        <img src="{{asset ('frontend/assets/img/ainspair/carft-thumb.png')}}" alt="img" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        <!-- Element-->
        <img src="{{asset ('frontend/assets/img/ainspair/carft-man.png')}}" alt="img" class="carft-man">
    </section>
    ...
    <section class="blog-sectionv2 position-relative fix section-padding">
            ...
            <div class="row g-lg-4 g-4">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="news-card-items">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/blogv2-a.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-a.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-a.png')}}');">
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="news-card-items">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/blogv2-b.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-b.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-b.png')}}');">
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="news-card-items">
                        <div class="news-image mb-xxl-4 mb-4">
                            <img src="{{asset ('frontend/assets/img/ablog/blogv2-c.png')}}" alt="img">
                            <div class="news-layer-wrapper">
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-c.png')}}');">
                                </div>
                                <div class="news-layer-image"
                                    style="background-image: url('{{asset ('frontend/assets/img/ablog/blogv2-c.png')}}');">
                                </div>
        ...
        <!-- Element -->
        <img src="{{asset ('frontend/assets/img/ablog/car-element.png')}}" alt="img" class="car-element">
    </section>
            ...
            <div class="row justify-content-between align-items-center g-4">
                ...
                <div class="col-lg-3 col-md-4 me-xl-5 col-sm-5">
                    <div class="stay-thumb w-100">
                        <img src="{{asset ('frontend/assets/img/aservices/stay-thumb.png')}}" alt="img" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        <!-- Element-->
        <img src="{{asset ('frontend/assets/img/aservices/stay-shape.png')}}" alt="img" class="stay-element">
    </section>
